        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbar-ex-collapse">
            <ul class="hidden-md hidden-sm nav navbar-nav navbar-right">
              ...
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo $user; ?>&nbsp;<i class="fa fa-caret-down text-inverse"></i></a>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    <h5 contenteditable="true"><?echo $user ?></h5>
                    <p>Info Akun</p>
                    <?php 
                    $query = mysqli_query($conn,"SELECT * FROM user,data_pembeli where username='$user'and iduser=kode_user  limit 1");
